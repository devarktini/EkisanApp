...
//     }
//   ];
const DealOfTheDay = ({vegetables, ViewAllProductList}) => {
  return (
    <View className="mt-4">
              <View className="flex-row justify-between items-center px-4">
            <View>
              <Text className="text-xl  font-bold text-[#048404] "> Fresh Vegetables</Text>
            ...
            <TouchableOpacity onPress={()=>ViewAllProductList("Vegetables")}>
