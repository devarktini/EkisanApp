              ...
              <ScrollView showsVerticalScrollIndicator={false} className="">
               <View>
                ...
                <View className="mb-6">
                  ...
                  >
                    <Text className="text-gray-700">{sowingDate.toDateString()}</Text>
                  </TouchableOpacity>
                    ...
                    >
                      <View className="flex-row flex-wrap justify-between">
                        {['acre', 'hectare', 'Bigha', 'Kattha'].map((unit) => (
                          <View key={unit} className="flex-row items-center w-[45%] mb-2">
                ...
                <View className="mb-6">
                  ...
                  <View className="bg-gray-50 p-4 rounded-xl border-2 border-gray-200">
                    {[
                      { label: "Irrigation Facility", value: irrigationFacility, setter: setIrrigationFacility },
                      { label: "Storage Facility", value: storageFacility, setter: setStorageFacility },
                      { label: "Chemical Fertilizer", value: chemicalFertilizer, setter: setChemicalFertilizer },
                      { label: "Soil Tested", value: soilTested, setter: setSoilTested },
                      { label: "Animal Husbandry", value: animalHusbandry, setter: setAnimalHusbandry }
                    ].map((item, index) => (
                      <View key={index} className="mb-4">
                        <Text className="text-gray-700 font-medium mb-2">{index + 1}. {item.label}</Text>
                        <RadioButton.Group
            ...
            <View className="flex-1 justify-center items-center bg-black bg-opacity-60">
              <View className="bg-white rounded-2xl w-11/12 max-h-[85%] shadow-xl">
                ...
                <View className="bg-green-500 p-4 rounded-t-2xl">
                  <Text className="text-2xl font-bold text-white text-center">Farm Details</Text>
                </View>
                  ...
                  // <ScrollView className="p-6">
                    <View className="space-y-4">
                      ...
                      <View className="bg-green-50 p-4 rounded-xl">
                        <Text className="text-xl font-bold text-green-800 mb-3">Basic Information</Text>
                        <View className="space-y-2">
                          <View className="flex-row justify-between items-center">
                            <Text className="text-base font-medium text-gray-600">Crop Type:</Text>
                            <Text className="text-base text-gray-800">{selectedFarm.cropType}</Text>
                          </View>
                          <View className="flex-row justify-between items-center">
                            <Text className="text-base font-medium text-gray-600">Crop Grown:</Text>
                            <Text className="text-base text-gray-800">{selectedFarm.cropName}</Text>
                          </View>
                          <View className="flex-row justify-between items-center">
                            <Text className="text-base font-medium text-gray-600">Sowing Date:</Text>
                            <Text className="text-base text-gray-800">{selectedFarm.dateOfSowing}</Text>
                          </View>
                          <View className="flex-row justify-between items-center">
                            <Text className="text-base font-medium text-gray-600">Farm Area:</Text>
                            <Text className="text-base text-gray-800">{selectedFarm.fieldArea} {selectedFarm.fieldSizeUnit}</Text>
                          </View>
                        </View>
                      </View>
                      ...
                      <View className="bg-blue-50 p-4 rounded-xl">
                        <Text className="text-xl font-bold text-blue-800 mb-3">Facilities</Text>
                        <View className="space-y-2">
                          <View className="flex-row justify-between items-center">
                            <Text className="text-base font-medium text-gray-600">Irrigation:</Text>
                            <Text className="text-base text-gray-800 capitalize">{selectedFarm.irrigation}</Text>
                          </View>
                          <View className="flex-row justify-between items-center">
                            <Text className="text-base font-medium text-gray-600">Storage:</Text>
                            <Text className="text-base text-gray-800 capitalize">{selectedFarm.storage}</Text>
                          </View>
                        </View>
                      </View>
                      ...
                      <View className="bg-purple-50 p-4 rounded-xl">
                        <Text className="text-xl font-bold text-purple-800 mb-3">Additional Details</Text>
                        <View className="space-y-2">
                          <View className="flex-row justify-between items-center">
                            <Text className="text-base font-medium text-gray-600">Chemical Fertilizer:</Text>
                            <Text className="text-base text-gray-800 capitalize">{selectedFarm.chemicalFertilizer}</Text>
                          </View>
                          <View className="flex-row justify-between items-center">
                            <Text className="text-base font-medium text-gray-600">Soil Tested:</Text>
                            <Text className="text-base text-gray-800 capitalize">{selectedFarm.soilTested}</Text>
                          </View>
                          <View className="flex-row justify-between items-center">
                            <Text className="text-base font-medium text-gray-600">Animal Husbandry:</Text>
                            <Text className="text-base text-gray-800 capitalize">{selectedFarm.animalHusbandry}</Text>
                          </View>
                        </View>
                      </View>
                    </View>
